...
const DashboardPage = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-inter gap-4 items-start justify-start mx-auto p-2 w-auto sm:w-full md:w-full">
        <Sidebar
          onClick={() => collapseSidebar(!collapsed)}
          className="!sticky !w-[240px] flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]"
        >
          <Menu
            menuItemStyles={{
              button: {
          ...
          >
            ...
            {/* <div className="sm:h-[393px] md:h-[49px] relative">

            
              </div> */}
              <div className="absolute top-0 mb-[35px] sm:h-[393px]"><Img
                    className=" sticky top-0 w-60"
            ...
            <div className="sm:h-[393px] md:h-[49px] h-[710px] relative w-full mt-9">
              ...
              <div className="absolute bottom-[0] flex flex-col gap-2 h-full inset-x-[0] items-center justify-start mx-auto p-2 w-full">
                <MenuItem>
                  <div className="flex flex-col items-center justify-start">
                    <div className="flex flex-row gap-2 items-center justify-start px-4 py-3 w-full pt-2">
                      <Img
                        className="h-4 w-4"
                ...
                {/* <div className="flex flex-col items-center justify-start mx-auto">
                  <div className="mb-[35px] pt-[11px] px-5 w-[86%]">
                  <div className="flex flex-row gap-3 md:h-auto items-center justify-start px-4 py-3 rounded-[20px] w-full">
                    <Img
                      className="h-4 w-60"
                      src="images/img_iconfromtablerio_gray_600.svg"
                      alt="iconfromtableri"
            ...
            <div className="bg-white-A700 flex flex-col gap-2 h-[261px] md:h-auto items-center justify-start p-6 sm:px-5 rounded-[16px] w-[260px]">
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <div className="h-[102px] relative w-full">
                  ...
                  >
                    <Text
                      className="mt-[11px] ml-[20px] md:text-3xl sm:text-[28px] text-[32px] text-center text-gray-900 tracking-[-1.59px]"
